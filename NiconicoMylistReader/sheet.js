var ControlSheet = /** @class */ (function () {
    ...
    ControlSheet.prototype.setDbKeys = function (dbInfos) {
        var vs = this.sheet.getRange(2, 4, this.sheet.getLastRow() - 1, 3).getValues();
        for (var i = 0; i < vs.length; i++) {
            if (vs[i][0] == '') {
                break;
